...
export function ChordsLibraryPage() {
  ...
  useSetPageAccent("#10CAB9");

  return (
    <PageLayout>
      <main id="main-content" className="relative flex-grow flex items-center py-24 overflow-hidden pt-28 sm:pt-32">
        <SEOHead
          title="Guitar Chord Library – Learn & Practice Chords | Minory"
          description="Explore Minory's chord library with clean diagrams and voicings for guitar, piano and ukulele. Learn, practice and transpose chords quickly."
          url="https://minory.studio/chords"
        />
            ...
            <div className="order-1 lg:order-2 flex flex-col justify-center space-y-8">
              <div>
                <div className="inline-flex items-center space-x-2 bg-white/15 px-3 py-1 rounded-full mb-6 border border-white/20">
                  ...
                  <span className="text-xs font-bold text-white tracking-widest uppercase">{t("pages.chords.studioTools")}</span>
                </div>
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-[1.1] mb-6">
                  {t("pages.chords.title1")}
                  <br />
                  <span className="text-white/95">{t("pages.chords.title2")}</span>
                </h1>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-white mb-1">{t("pages.chords.voicings")}</h3>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-white mb-1">{t("pages.chords.offline")}</h3>
                    <p className="text-sm text-white/85">
