        ...
        <Container fullWidth>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="relative order-2 lg:order-1">
              ...
              <PhoneHero src="/tuner-dark.PNG" alt="Minory Tuner" />
            </div>
            ...
            <div className="order-1 lg:order-2 flex flex-col justify-center space-y-8">
              <div>
                <div className="inline-flex items-center space-x-2 bg-primary/5 dark:bg-primary/20 px-3 py-1 rounded-full mb-6">
                  ...
                  <span className="text-xs font-bold text-primary tracking-widest uppercase">{t("pages.tuner.studioTools")}</span>
                </div>
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-neutral-900 dark:text-white leading-[1.1] mb-6">
                  ...
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary/80">{t("pages.tuner.title2")}</span>
                </h1>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-neutral-900 dark:text-white mb-1">{t("pages.tuner.instantResponse")}</h3>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-neutral-900 dark:text-white mb-1">{t("pages.tuner.darkMode")}</h3>
                    <p className="text-sm text-neutral-500 dark:text-neutral-400">
